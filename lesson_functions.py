...
def get_features(img, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins,feature_vec=False):
    ...
    hog_feat1 = get_hog_features(ch1, orient, pix_per_cell, cell_per_block, feature_vec)
    hog_feat2 = get_hog_features(ch2, orient, pix_per_cell, cell_per_block, feature_vec)
    hog_feat3 = get_hog_features(ch3, orient, pix_per_cell, cell_per_block, feature_vec)
    ...
    X_unscaled = np.hstack((spatial_features, hist_features, hog_features)).reshape(1, -1)
